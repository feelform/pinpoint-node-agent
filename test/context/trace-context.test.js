...
test('Should create continued trace and add span info', function (t) {
  ...
  const traceContext = new TraceContext(fixture.getAgentInfo(), dataSenderMock(), agent.config)
...
test('new Trace', (t) => {
  ...
  const dut = new TraceContext(fixture.getAgentInfo(), dataSenderMock(), agent.config)
